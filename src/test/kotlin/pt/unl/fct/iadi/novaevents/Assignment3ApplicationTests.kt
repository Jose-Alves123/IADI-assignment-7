...
class Assignment3ApplicationTests {
        ...
        fun clubsPageRendersTableAndNavbar() {
                mockMvc.perform(get("/clubs"))
                        ...
                        .andExpect(
                                content().string(org.hamcrest.Matchers.containsString("<tbody>"))
                        )
                        .andExpect(
                                content()
                                        .string(org.hamcrest.Matchers.containsString("Nova Events"))
                        )
                        .andExpect(
                                content().string(org.hamcrest.Matchers.containsString(">Clubs<"))
                        )
                        .andExpect(
                                content().string(org.hamcrest.Matchers.containsString(">Events<"))
                        )
        }
        ...
        fun eventsPageRendersActionLinks() {
                mockMvc.perform(get("/events"))
                        ...
                        .andExpect(
                                content().string(org.hamcrest.Matchers.containsString("/delete"))
                        )
        }
